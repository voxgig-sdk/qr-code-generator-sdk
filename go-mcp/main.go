// Command QrCodeGenerator-mcp is an MCP server exposing the QrCodeGenerator
// SDK as MCP tools.
//
// Two tools are registered:
//
//	QrCodeGenerator_list  — list records of an entity
//	QrCodeGenerator_load  — load a single record of an entity
//
