...
type Args struct {
	Entity string         `json:"entity" jsonschema:"qrn"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.QrCodeGeneratorSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "qr-code-generator_list",
		Description: "List records from QrCodeGenerator. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "qr-code-generator_load",
		Description: "Load a single record from QrCodeGenerator. " +
...
func runOp(client *sdk.QrCodeGeneratorSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.QrCodeGeneratorSDK, name string) (sdk.QrCodeGeneratorEntity, error) {
	switch strings.ToLower(name) {
	case "qrn":
		return client.Qrn(nil), nil
