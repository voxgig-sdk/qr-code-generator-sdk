...
AQL-driven CLI and REPL for the QrCodeGenerator SDK. Positional arguments are
...
```sh
go build -o qr-code-generator-cli ./...
```
...
./qr-code-generator-cli list qrn
./qr-code-generator-cli load 1 qrn
./qr-code-generator-cli load '{id:1}' qrn
