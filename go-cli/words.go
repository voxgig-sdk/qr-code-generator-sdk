...
func registerSDKWords(r *eng.Registry, client *sdk.QrCodeGeneratorSDK) {
...
func runOp(client *sdk.QrCodeGeneratorSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
