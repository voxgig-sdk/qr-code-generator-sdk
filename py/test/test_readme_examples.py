# QrCodeGenerator SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions QrCodeGeneratorSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both QrCodeGeneratorSDK(...) and QrCodeGeneratorSDK.test(...) become
#      QrCodeGeneratorSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "qrcodegenerator_sdk"
_SDK_CLASS = "QrCodeGeneratorSDK"
