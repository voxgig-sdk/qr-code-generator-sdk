...
from qrcodegenerator_sdk.utility import register

# Load features
from qrcodegenerator_sdk.feature.base_feature import QrCodeGeneratorBaseFeature
from qrcodegenerator_sdk.features import _has_feature, _make_feature
...
class QrCodeGeneratorSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = QrCodeGeneratorUtility()
        self._utility = utility

        from qrcodegenerator_sdk.config import shared_config
    ...
    def get_utility(self):
        return QrCodeGeneratorUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("QrCodeGeneratorSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Qrn(self, data=None) -> "QrnEntity":
        ...
        from qrcodegenerator_sdk.entity.qrn_entity import QrnEntity
