...
class QrnEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set QR_CODE_GENERATOR_TEST_QRN_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def qrn_basic_setup(extra)
  ...
  entid_env_raw = ENV["QR_CODE_GENERATOR_TEST_QRN_ENTID"]
