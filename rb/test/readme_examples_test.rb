...
#      offline in seeded test mode (QrCodeGeneratorSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "QrCodeGenerator_sdk.rb")
  SDK_CLASS = "QrCodeGeneratorSDK"
