...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.QRCODEGENERATOR_TEST_LIVE ||
    'TRUE' === process.env.QRCODEGENERATOR_TEST_OVERRIDE
  ) {
  ...
  m.QRCODEGENERATOR_TEST_EXPLAIN = process.env.QRCODEGENERATOR_TEST_EXPLAIN || m.QRCODEGENERATOR_TEST_EXPLAIN
