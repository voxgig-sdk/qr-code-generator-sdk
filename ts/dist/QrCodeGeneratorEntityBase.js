...
exports.QrCodeGeneratorEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends QrCodeGeneratorEntityBase<Advice>`.
class QrCodeGeneratorEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.QrCodeGeneratorEntityBase = QrCodeGeneratorEntityBase;
//# sourceMappingURL=QrCodeGeneratorEntityBase.js.map