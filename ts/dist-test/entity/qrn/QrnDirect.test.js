...
(0, node_test_1.describe)('QrnDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.QrCodeGeneratorSDK({
    ...
    (0, node_test_1.test)('direct-load-qrn', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-qrn', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.QR_CODE_GENERATOR_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.QrCodeGeneratorSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['QR_CODE_GENERATOR_TEST_QRN_ENTID'];
    ...
    const client = new __1.QrCodeGeneratorSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=QrnDirect.test.js.map