...
function envOverride(m) {
    if ('TRUE' === process.env.QR_CODE_GENERATOR_TEST_LIVE ||
        'TRUE' === process.env.QR_CODE_GENERATOR_TEST_OVERRIDE) {
    ...
    m.QR_CODE_GENERATOR_TEST_EXPLAIN = process.env.QR_CODE_GENERATOR_TEST_EXPLAIN || m.QR_CODE_GENERATOR_TEST_EXPLAIN;
    return m;
}
