...
function runner.env_override(m)
  local live = runner.getenv("QRCODEGENERATOR_TEST_LIVE")
  local override = runner.getenv("QRCODEGENERATOR_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("QRCODEGENERATOR_TEST_EXPLAIN")
