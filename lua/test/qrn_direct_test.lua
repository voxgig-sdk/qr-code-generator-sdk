...
describe("QrnDirect", function()
  it("should direct-load-qrn", function()
    local setup = qrn_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-qrn", setup.live and "live" or "unit")
