...
Results: Successfully generated QR code image.
...
| --- | --- | --- | --- |
| Qrn | `load` | `GET /qr/` | See reference |

## Connect to the API

- Production server: `https://api.apgy.in`
...
- `qr-code-generator_list`: List records for an entity. No active entity supports this operation.
- `qr-code-generator_load`: Load one record for an entity. Supported entities: `qrn`.
