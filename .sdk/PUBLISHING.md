...
|---|---|---|
| `ts/` | @voxgig-sdk/qr-code-generator-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/qr-code-generator-sdk \
      --repository voxgig-sdk/qr-code-generator-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/qr-code-generator-sdk` shows it, and
`npm trust revoke @voxgig-sdk/qr-code-generator-sdk --id=<id>` removes it.
