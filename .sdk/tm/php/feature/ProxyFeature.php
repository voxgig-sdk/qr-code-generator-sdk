...
// QrCodeGenerator SDK proxy feature
...
class QrCodeGeneratorProxyFeature extends QrCodeGeneratorBaseFeature
{
    ...
    public function init(QrCodeGeneratorContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (QrCodeGeneratorContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
