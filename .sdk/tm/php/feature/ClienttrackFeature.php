...
// QrCodeGenerator SDK clienttrack feature
...
class QrCodeGeneratorClienttrackFeature extends QrCodeGeneratorBaseFeature
{
    ...
    public function PostConstruct(QrCodeGeneratorContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'QrCodeGenerator-SDK';
