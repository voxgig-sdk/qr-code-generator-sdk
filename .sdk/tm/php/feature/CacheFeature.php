...
// QrCodeGenerator SDK cache feature
...
class QrCodeGeneratorCacheFeature extends QrCodeGeneratorBaseFeature
{
    ...
    private function _through(QrCodeGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
