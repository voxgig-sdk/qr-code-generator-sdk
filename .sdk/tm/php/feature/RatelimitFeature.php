...
// QrCodeGenerator SDK ratelimit feature
...
class QrCodeGeneratorRatelimitFeature extends QrCodeGeneratorBaseFeature
{
    ...
    private function _acquire(QrCodeGeneratorContext $ctx): void
    {
    ...
    private function _track(QrCodeGeneratorContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
