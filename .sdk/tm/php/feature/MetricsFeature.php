...
// QrCodeGenerator SDK metrics feature
...
class QrCodeGeneratorMetricsFeature extends QrCodeGeneratorBaseFeature
{
    ...
    private function _record(QrCodeGeneratorContext $ctx, bool $ok): void
    {
