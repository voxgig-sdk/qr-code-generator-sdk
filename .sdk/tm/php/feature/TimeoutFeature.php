...
// QrCodeGenerator SDK timeout feature
...
class QrCodeGeneratorTimeoutFeature extends QrCodeGeneratorBaseFeature
{
    ...
    private function _with_timeout(QrCodeGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(QrCodeGeneratorContext $_ctx, float $ms): void
    {
        $client = $this->client;
