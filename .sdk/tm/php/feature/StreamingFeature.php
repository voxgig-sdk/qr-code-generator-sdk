...
// QrCodeGenerator SDK streaming feature
...
class QrCodeGeneratorStreamingFeature extends QrCodeGeneratorBaseFeature
{
    ...
    private function _iterate(QrCodeGeneratorResult $result): \Generator
    {
    ...
    private function _streamable(QrCodeGeneratorContext $ctx): bool
    {
