...
// QrCodeGenerator SDK utility: fetcher

class QrCodeGeneratorFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; QrCodeGeneratorSDK/1.0)';
    ...
    public static function call(QrCodeGeneratorContext $ctx, string $fullurl, array $fetchdef): array
    {
