...
// QrCodeGenerator SDK utility: make_options

class QrCodeGeneratorMakeOptions
{
    ...
    public static function call(QrCodeGeneratorContext $ctx): array
    {
        ...
        //
        // `QrCodeGeneratorSchema::optspec()` is built from the model:
        ...
        $optspec = QrCodeGeneratorSchema::optspec();
