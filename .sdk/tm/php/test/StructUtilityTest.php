...
// QrCodeGenerator SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = QrCodeGeneratorOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(QrCodeGeneratorOmni::structfix($now, Struct::undef()))
                        !== json_encode(QrCodeGeneratorOmni::structfix($val, Struct::undef()))) {
