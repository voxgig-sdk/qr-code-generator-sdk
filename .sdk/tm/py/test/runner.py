...
class QrCodeGeneratorTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = QrCodeGeneratorTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = QrCodeGeneratorTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = QrCodeGeneratorTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
