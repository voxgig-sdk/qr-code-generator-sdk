...
import (
	"github.com/voxgig-sdk/qr-code-generator-sdk/go/core"

	vs "github.com/voxgig-sdk/qr-code-generator-sdk/go/utility/struct"
)

type QrnEntity struct {
	name    string
	client  *core.QrCodeGeneratorSDK
...
func NewQrnEntity(client *core.QrCodeGeneratorSDK, entopts map[string]any) *QrnEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *QrnEntity) GetName() string { return e.name }
...
func (e *QrnEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *QrnEntity) Deleted() bool {
	return e.deleted
}


func (e *QrnEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewQrnEntity(e.client, opts)
}

func (e *QrnEntity) Data(args ...any) any {
...
func (e *QrnEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Qrn; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *QrnEntity) DataTyped(data ...Qrn) Qrn {
	if len(data) > 0 {
		return typedFrom[Qrn](e.Data(asMap(data[0])))
	}
	return typedFrom[Qrn](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Qrn (all fields
// optional at the wire level).
func (e *QrnEntity) MatchTyped(match ...Qrn) Qrn {
	if len(match) > 0 {
		return typedFrom[Qrn](e.Match(asMap(match[0])))
	}
	return typedFrom[Qrn](e.Match())
}
...
func (e *QrnEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *QrnEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// QrnLoadMatch and returns an Qrn. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *QrnEntity) LoadTyped(reqmatch QrnLoadMatch, ctrl map[string]any) (Qrn, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Qrn{}, err
	}
	return typedFrom[Qrn](res), nil
}



func (e *QrnEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *QrnEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *QrnEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *QrnEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *QrnEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
