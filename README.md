...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/qr-code-generator` | `npm install @voxgig-sdk/qr-code-generator` |
| Python | `voxgig-sdk-qr-code-generator` | `pip install voxgig-sdk-qr-code-generator` |
| PHP | `voxgig-sdk/qr-code-generator` | `composer require voxgig-sdk/qr-code-generator` |
| Golang | `github.com/voxgig-sdk/qr-code-generator-sdk/go` | `go get github.com/voxgig-sdk/qr-code-generator-sdk/go` |
| Ruby | `voxgig-sdk-qr-code-generator` | `gem install voxgig-sdk-qr-code-generator` |
| Lua | `voxgig-sdk-qr-code-generator` | `luarocks install voxgig-sdk-qr-code-generator` |
