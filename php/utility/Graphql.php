...
// QrCodeGenerator SDK utility: graphql
//
...
class QrCodeGeneratorGraphql
{
    ...
    // equivalent.
    public static function body(QrCodeGeneratorContext $ctx): mixed
    {
    ...
    public static function errors(QrCodeGeneratorContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
