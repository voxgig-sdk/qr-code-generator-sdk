...
class QrnEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set QR_CODE_GENERATOR_TEST_QRN_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function qrn_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("QR_CODE_GENERATOR_TEST_QRN_ENTID");
