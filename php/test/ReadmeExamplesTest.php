...
// QrCodeGenerator SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (QrCodeGeneratorSDK::test)
...
{
    private const SDK_CLASS = 'QrCodeGeneratorSDK';
    ...
    private const SDK_BASE = 'qrcodegenerator_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../qrcodegenerator_sdk.php';
