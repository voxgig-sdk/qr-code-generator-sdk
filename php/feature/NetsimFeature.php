...
// QrCodeGenerator SDK netsim feature
...
class QrCodeGeneratorNetsimFeature extends QrCodeGeneratorBaseFeature
{
    ...
    private function _simulate(QrCodeGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(QrCodeGeneratorContext $ctx, array $applied): void
    {
        $client = $this->client;
