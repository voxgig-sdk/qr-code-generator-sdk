...
// QrCodeGenerator SDK audit feature
...
class QrCodeGeneratorAuditFeature extends QrCodeGeneratorBaseFeature
{
    ...
    private function _emit(QrCodeGeneratorContext $ctx, string $outcome): void
    {
