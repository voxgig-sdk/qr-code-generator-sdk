...
// QrCodeGenerator SDK rbac feature
...
class QrCodeGeneratorRbacFeature extends QrCodeGeneratorBaseFeature
{
    ...
    private function _required(QrCodeGeneratorContext $ctx): ?string
    {
    ...
    private function _reject(QrCodeGeneratorContext $ctx, string $required): void
    {
    ...
    private function _track(QrCodeGeneratorContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
