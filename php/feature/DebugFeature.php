...
// QrCodeGenerator SDK debug feature
...
class QrCodeGeneratorDebugFeature extends QrCodeGeneratorBaseFeature
{
    ...
    private function _finish(QrCodeGeneratorContext $ctx, bool $ok): void
    {
