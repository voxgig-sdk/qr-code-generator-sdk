...
// QrCodeGenerator SDK idempotency feature
...
class QrCodeGeneratorIdempotencyFeature extends QrCodeGeneratorBaseFeature
{
    ...
    private function _mutating(QrCodeGeneratorContext $ctx): bool
    {
